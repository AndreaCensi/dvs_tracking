...
We used infrared LEDs (\inputencoding{latin1}{\textbf{CB: part number,
specs?}}\inputencoding{latin9}) since the DVS is very sensitive to
...
to minimize the confusion between with background motion (see \prettyref{sub:Alternate-events-and-motion}
below).
...
In this scenario both the \ALMs and the DVS are fixed. \prettyref{fig:events-hist}\emph{a}
