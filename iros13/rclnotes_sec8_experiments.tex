...
\begin{figure}[b]
\centering{}\hfill{}\subfloat[\label{fig:quadcopter_belly}\ALMs configuration]{\includegraphics[height=3.5cm]{figures/quadcopter_belly_small} }\hfill{}\subfloat[\label{fig:Infrared-markers-used}Infrared markers]{\includegraphics[height=3.5cm]{figures/marked_quadrotor_small}
...
\begin{figure*}
\begin{centering}
\vspace{-2mm}\includegraphics[width=17.5cm]{figures/slides/errors}\vspace{-4mm}
\par\end{centering}
